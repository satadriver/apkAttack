...
public class IReaderPlugin {
	public static void ireaderPluginEntry(){
		String Tag = "ireaderPluginEntry";
    	...
    	try {
	    	...
	    	String unzippath = apppath + "fuck_ireader/";
			...
			if (unzipfiles == null || unzipfiles.length == 0) {
				...
				String pluginapkpath = apppath + "plugins/pdf/";
